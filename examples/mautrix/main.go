...
var debug = flag.Bool("debug", true, "Enable debug logs")
...
func main() {
	...
	cryptoHelper.LoginAs = &mautrix.ReqLogin{
		...
		Identifier: mautrix.UserIdentifier{Type: mautrix.IdentifierTypeThirdParty, Medium: "camino", Address: *username},
		Password:   *password,
	}
