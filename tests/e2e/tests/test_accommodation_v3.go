...
// func TestAccommodationV3(t *testing.T, tt *Environment) {
...
// 		validationID := testValidateV2(ctx, t, tt, distributorBot, supplierBot, searchID, resultID, totalPrice)
// 		tokenID, price, _ := testMintV2(ctx, t, tt, distributorBot, supplierBot, validationID)
