...
// func testBotSanitySetupWithSanityChecks(ctx context.Context, t *testing.T, tt *Environment) (services *botSanityServices) {
...
// func TestBotSanity(t *testing.T, tt *Environment) {
