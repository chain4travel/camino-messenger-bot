...
func testActivityV1ProductListService(
	...
	resp, err := distributorBot.ActivityProductListServiceV1.ActivityProductList(
	...
	tt.logger.Debug("ActivityProductListServiceV1.ActivityProductList response:\n", protoMessageToJSON(tt, resp))
...
func testActivityV1ProductInfoService(
	ctx context.Context,
	t *testing.T,
	tt *Test,
	distributorBot *bot.Bot,
	...
	allActivitiesResp, err := distributorBot.ActivityProductInfoServiceV1.ActivityProductInfo(
		requestContext(ctx, &metadata.Metadata{
			RecipientCMAccount: supplierBot.CMAccountAddress().Hex(),
		}),
		req,
	...
	supplierCode1 := activityV1ProductCode
...
func testActivityV1SearchServiceWithoutCurrency(
	ctx context.Context,
	t *testing.T,
	tt *Test,
	distributorBot *bot.Bot,
	...
	tt.logger.Debug("ActivitySearchServiceV1.ActivitySearch response:\n", protoMessageToJSON(tt, resp))
	require.Equal(t, typesv1.StatusType_STATUS_TYPE_FAILURE, resp.Header.Status, "unexpected response status")
}

func testActivityV1SearchServiceWithoutTravelPeriod(
	ctx context.Context,
	t *testing.T,
	tt *Test,
	distributorBot *bot.Bot,
...
func testActivityV1SearchServiceTravelPeriodOutOfBounds(
	ctx context.Context,
	t *testing.T,
	tt *Test,
	distributorBot *bot.Bot,
...
func testActivityV1SearchServiceTravelPeriodReversed(
	ctx context.Context,
	t *testing.T,
	tt *Test,
	distributorBot *bot.Bot,
...
func testactivityv1SearchServiceWithTravelPeriod(
	...
	tt.logger.Debug("ActivitySearchServiceV1.ActivitySearch request:\n", protoMessageToJSON(tt, req))
...
func testactivityv1VerifyBlockchainState(
	ctx context.Context,
	t *testing.T,
	tt *Test,
	distributorBot *bot.Bot,
...
func TestActivityV1(t *testing.T, tt *Test) {
	ctx, cancel := context.WithTimeout(context.Background(), defaultTestTimeout)
	defer cancel()
	_, supplierBot, distributorBot := testActivityV1Setup(ctx, t, tt)
	...
	t.Run("Product info", func(t *testing.T) {
		// Happy path: will return only one activity
		testActivityV1ProductInfoService(ctx, t, tt, distributorBot, supplierBot)
	})
	t.Run("Product Search without currency", func(t *testing.T) {
		testActivityV1SearchServiceWithoutCurrency(ctx, t, tt, distributorBot, supplierBot)
	})
	t.Run("Product Search without travel period", func(t *testing.T) {
		testActivityV1SearchServiceWithoutTravelPeriod(ctx, t, tt, distributorBot, supplierBot)
	})
	t.Run("Product Search travel period out of bounds", func(t *testing.T) {
		testActivityV1SearchServiceTravelPeriodOutOfBounds(ctx, t, tt, distributorBot, supplierBot)
	})
	t.Run("Product Search travel period reversed", func(t *testing.T) {
		testActivityV1SearchServiceTravelPeriodReversed(ctx, t, tt, distributorBot, supplierBot)
	})

	t.Run("Search->Validate->Mint->VerifyBlockchain", func(t *testing.T) {
		searchID, resultID, totalPrice := testactivityv1SearchServiceWithTravelPeriod(ctx, t, tt, distributorBot, supplierBot)
		validationID := testactivityv1ValidateV2(ctx, t, tt, distributorBot, supplierBot, searchID, resultID, totalPrice)
		tokenID, price := testactivityv1MintV2(ctx, t, tt, distributorBot, supplierBot, validationID)
		testactivityv1VerifyBlockchainState(ctx, t, tt, distributorBot, tokenID, price)
	})
}
