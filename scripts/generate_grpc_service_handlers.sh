...
# TODO: figure out why claim imports typev instead of typev1 and
...
function generate_register_services_server() {
	...
	
	{
		...
		echo
		echo "import ("
		echo "    \"github.com/chain4travel/camino-messenger-bot/internal/rpc\""
...
function generate_register_services_client() {
	...
	
	{
		...
		echo
		echo "import ("
		echo "    \"github.com/chain4travel/camino-messenger-bot/internal/messaging/types\""
		echo "    \"github.com/chain4travel/camino-messenger-bot/internal/rpc\""
		echo "    \"google.golang.org/grpc\""
		echo ")"
		echo
