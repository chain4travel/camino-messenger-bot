...
var _ infov2grpc.CountryEntryRequirementsServiceServer = (*infov2CountryEntryRequirementsServiceSrv)(nil)

type infov2CountryEntryRequirementsServiceSrv struct {
...
func registerCountryEntryRequirementsServiceV2Server(grpcServer *grpc.Server, reqProcessor rpc.ExternalRequestProcessor) {
	infov2grpc.RegisterCountryEntryRequirementsServiceServer(grpcServer, &infov2CountryEntryRequirementsServiceSrv{reqProcessor})
}
