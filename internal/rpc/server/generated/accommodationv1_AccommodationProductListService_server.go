...
var _ accommodationv1grpc.AccommodationProductListServiceServer = (*accommodationv1AccommodationProductListServiceSrv)(nil)

type accommodationv1AccommodationProductListServiceSrv struct {
...
func registerAccommodationProductListServiceV1Server(grpcServer *grpc.Server, reqProcessor rpc.ExternalRequestProcessor) {
	accommodationv1grpc.RegisterAccommodationProductListServiceServer(grpcServer, &accommodationv1AccommodationProductListServiceSrv{reqProcessor})
}
