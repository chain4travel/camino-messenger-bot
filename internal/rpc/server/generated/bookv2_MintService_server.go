...
var _ bookv2grpc.MintServiceServer = (*bookv2MintServiceSrv)(nil)

type bookv2MintServiceSrv struct {
...
func registerMintServiceV2Server(grpcServer *grpc.Server, reqProcessor rpc.ExternalRequestProcessor) {
	bookv2grpc.RegisterMintServiceServer(grpcServer, &bookv2MintServiceSrv{reqProcessor})
}
