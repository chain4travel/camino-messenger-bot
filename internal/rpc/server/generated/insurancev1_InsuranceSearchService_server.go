...
var _ insurancev1grpc.InsuranceSearchServiceServer = (*insurancev1InsuranceSearchServiceSrv)(nil)

type insurancev1InsuranceSearchServiceSrv struct {
...
func registerInsuranceSearchServiceV1Server(grpcServer *grpc.Server, reqProcessor rpc.ExternalRequestProcessor) {
	insurancev1grpc.RegisterInsuranceSearchServiceServer(grpcServer, &insurancev1InsuranceSearchServiceSrv{reqProcessor})
}
