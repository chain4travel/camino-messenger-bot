...
var _ accommodationv2grpc.AccommodationProductInfoServiceServer = (*accommodationv2AccommodationProductInfoServiceSrv)(nil)

type accommodationv2AccommodationProductInfoServiceSrv struct {
...
func registerAccommodationProductInfoServiceV2Server(grpcServer *grpc.Server, reqProcessor rpc.ExternalRequestProcessor) {
	accommodationv2grpc.RegisterAccommodationProductInfoServiceServer(grpcServer, &accommodationv2AccommodationProductInfoServiceSrv{reqProcessor})
}
