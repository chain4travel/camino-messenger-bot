...
var _ insurancev1grpc.InsuranceProductInfoServiceServer = (*insurancev1InsuranceProductInfoServiceSrv)(nil)

type insurancev1InsuranceProductInfoServiceSrv struct {
...
func registerInsuranceProductInfoServiceV1Server(grpcServer *grpc.Server, reqProcessor rpc.ExternalRequestProcessor) {
	insurancev1grpc.RegisterInsuranceProductInfoServiceServer(grpcServer, &insurancev1InsuranceProductInfoServiceSrv{reqProcessor})
}
