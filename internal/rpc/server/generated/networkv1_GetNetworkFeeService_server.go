...
var _ networkv1grpc.GetNetworkFeeServiceServer = (*networkv1GetNetworkFeeServiceSrv)(nil)

type networkv1GetNetworkFeeServiceSrv struct {
...
func registerGetNetworkFeeServiceV1Server(grpcServer *grpc.Server, reqProcessor rpc.ExternalRequestProcessor) {
	networkv1grpc.RegisterGetNetworkFeeServiceServer(grpcServer, &networkv1GetNetworkFeeServiceSrv{reqProcessor})
}
