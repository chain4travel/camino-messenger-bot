...
func (s *server) Mint(ctx context.Context, request *bookv1alpha.MintRequest) (*bookv1alpha.MintResponse, error) {
	response, err := s.processInternalRequest(ctx, messaging.MintRequest, &messaging.RequestContent{MintRequest: *request})
...
func (s *server) Validation(ctx context.Context, request *bookv1alpha.ValidationRequest) (*bookv1alpha.ValidationResponse, error) {
	response, err := s.processInternalRequest(ctx, messaging.ValidationRequest, &messaging.RequestContent{ValidationRequest: *request})
