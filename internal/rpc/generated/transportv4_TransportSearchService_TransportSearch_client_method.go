...
func (s TransportSearchServiceV4Client) Call(ctx context.Context, requestIntf protoreflect.ProtoMessage, opts ...grpc.CallOption) (protoreflect.ProtoMessage, types.MessageType, error) {
	...
	if !ok {
		return s.errorResponse(fmt.Sprintf("invalid request type: expected %s, got %T", TransportSearchServiceV4Request, requestIntf)), messageType, nil
	}
...
func (s *TransportSearchServiceV4Client) ErrorResponseAndType(errorMessage string) (protoreflect.ProtoMessage, types.MessageType) {
	return s.errorResponse(errorMessage), TransportSearchServiceV4Response
}

func (s *TransportSearchServiceV4Client) errorResponse(errorMessage string) protoreflect.ProtoMessage {
