...
var _ accommodationv4grpc.AccommodationProductInfoServiceServer = (*accommodationv4AccommodationProductInfoServiceServer)(nil)

type accommodationv4AccommodationProductInfoServiceServer struct {
...
func registerAccommodationProductInfoServiceV4Server(grpcServer *grpc.Server, reqHandler rpc.RequestHandler) {
	accommodationv4grpc.RegisterAccommodationProductInfoServiceServer(grpcServer, &accommodationv4AccommodationProductInfoServiceServer{reqHandler})
}
