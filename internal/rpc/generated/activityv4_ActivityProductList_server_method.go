...
func (s *activityv4ActivityProductListServer) ActivityProductList(ctx context.Context, request *activityv4.ActivityProductListRequest) (*activityv4.ActivityProductListResponse, error) {
	...
	if !ok {
		return s.errorResponse(fmt.Sprintf("invalid response type: expected %s, got %T", ActivityProductListServiceV4Response, responseIntf)), nil
	}

	return response, nil
}

func (s *activityv4ActivityProductListServer) errorResponse(errorMessage string) *activityv4.ActivityProductListResponse {
