...
func (s PingServiceV1Client) Call(ctx context.Context, requestIntf protoreflect.ProtoMessage, opts ...grpc.CallOption) (protoreflect.ProtoMessage, types.MessageType, error) {
	...
	if !ok {
		return s.errorResponse(fmt.Sprintf("invalid request type: expected %s, got %T", PingServiceV1Request, requestIntf)), messageType, nil
	}
...
func (s *PingServiceV1Client) ErrorResponseAndType(errorMessage string) (protoreflect.ProtoMessage, types.MessageType) {
	return s.errorResponse(errorMessage), PingServiceV1Response
}

func (s *PingServiceV1Client) errorResponse(errorMessage string) protoreflect.ProtoMessage {
