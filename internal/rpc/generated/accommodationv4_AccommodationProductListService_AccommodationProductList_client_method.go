...
func (s AccommodationProductListServiceV4Client) Call(ctx context.Context, requestIntf protoreflect.ProtoMessage, opts ...grpc.CallOption) (protoreflect.ProtoMessage, types.MessageType, error) {
	...
	if !ok {
		return s.errorResponse(fmt.Sprintf("invalid request type: expected %s, got %T", AccommodationProductListServiceV4Request, requestIntf)), messageType, nil
	}
...
func (s *AccommodationProductListServiceV4Client) ErrorResponseAndType(errorMessage string) (protoreflect.ProtoMessage, types.MessageType) {
	return s.errorResponse(errorMessage), AccommodationProductListServiceV4Response
}

func (s *AccommodationProductListServiceV4Client) errorResponse(errorMessage string) protoreflect.ProtoMessage {
