...
func (s *TransportProductListServiceV3Client) ErrorResponseAndType(errorMessage string) (protoreflect.ProtoMessage, types.MessageType) {
	return s.errorResponse(errorMessage), TransportProductListServiceV3Response
}

func (s *TransportProductListServiceV3Client) errorResponse(errorMessage string) protoreflect.ProtoMessage {
