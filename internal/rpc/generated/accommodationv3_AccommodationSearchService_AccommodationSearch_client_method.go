...
func (s AccommodationSearchServiceV3Client) Call(ctx context.Context, requestIntf protoreflect.ProtoMessage, opts ...grpc.CallOption) (protoreflect.ProtoMessage, types.MessageType, error) {
	...
	if !ok {
		return s.errorResponse(fmt.Sprintf("invalid request type: expected %s, got %T", AccommodationSearchServiceV3Request, requestIntf)), messageType, nil
	}
...
func (s *AccommodationSearchServiceV3Client) ErrorResponseAndType(errorMessage string) (protoreflect.ProtoMessage, types.MessageType) {
	return s.errorResponse(errorMessage), AccommodationSearchServiceV3Response
}

func (s *AccommodationSearchServiceV3Client) errorResponse(errorMessage string) protoreflect.ProtoMessage {
