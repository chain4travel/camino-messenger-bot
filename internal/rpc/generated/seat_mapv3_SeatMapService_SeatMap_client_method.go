...
func (s SeatMapServiceV3Client) Call(ctx context.Context, requestIntf protoreflect.ProtoMessage, opts ...grpc.CallOption) (protoreflect.ProtoMessage, types.MessageType, error) {
	...
	if !ok {
		return s.errorResponse(fmt.Sprintf("invalid request type: expected %s, got %T", SeatMapServiceV3Request, requestIntf)), messageType, nil
	}
...
func (s *SeatMapServiceV3Client) ErrorResponseAndType(errorMessage string) (protoreflect.ProtoMessage, types.MessageType) {
	return s.errorResponse(errorMessage), SeatMapServiceV3Response
}

func (s *SeatMapServiceV3Client) errorResponse(errorMessage string) protoreflect.ProtoMessage {
