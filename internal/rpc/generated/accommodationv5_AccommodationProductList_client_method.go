...
func (s *AccommodationProductListV5Client) Call(ctx context.Context, requestIntf protoreflect.ProtoMessage, opts ...grpc.CallOption) (protoreflect.ProtoMessage, message.Type) {
	messageType := AccommodationProductListServiceV5Response

	request, ok := requestIntf.(*accommodationv5.AccommodationProductListRequest)
	if !ok {
		return s.errorResponse(typesv4.ErrorCode_ERROR_CODE_INTERNAL, fmt.Sprintf("invalid request type: expected %s, got %T", AccommodationProductListServiceV5Request, requestIntf)), messageType
	}
...
func (s *AccommodationProductListV5Client) InvalidProtoErrResponseAndType(errorMessage string) (protoreflect.ProtoMessage, message.Type) {
	return s.errorResponse(typesv4.ErrorCode_ERROR_CODE_INVALID_PROTO, errorMessage), AccommodationProductListServiceV5Response
}

func (s *AccommodationProductListV5Client) errorResponse(code typesv4.ErrorCode, errorMessage string) *accommodationv5.AccommodationProductListResponse {
	return &accommodationv5.AccommodationProductListResponse{
		Response: &accommodationv5.AccommodationProductListResponse_ErrorResponse{
			ErrorResponse: &accommodationv5.AccommodationProductListErrorResponse{
