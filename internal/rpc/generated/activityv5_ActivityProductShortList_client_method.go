...
func (s *ActivityProductShortListV5Client) Call(ctx context.Context, requestIntf protoreflect.ProtoMessage, opts ...grpc.CallOption) (protoreflect.ProtoMessage, message.Type) {
	messageType := ActivityProductShortListServiceV5Response

	request, ok := requestIntf.(*activityv5.ActivityProductShortListRequest)
	if !ok {
		return s.errorResponse(typesv4.ErrorCode_ERROR_CODE_INTERNAL, fmt.Sprintf("invalid request type: expected %s, got %T", ActivityProductShortListServiceV5Request, requestIntf)), messageType
	}
...
func (s *ActivityProductShortListV5Client) InvalidProtoErrResponseAndType(errorMessage string) (protoreflect.ProtoMessage, message.Type) {
	return s.errorResponse(typesv4.ErrorCode_ERROR_CODE_INVALID_PROTO, errorMessage), ActivityProductShortListServiceV5Response
}

func (s *ActivityProductShortListV5Client) errorResponse(code typesv4.ErrorCode, errorMessage string) *activityv5.ActivityProductShortListResponse {
	return &activityv5.ActivityProductShortListResponse{
		Response: &activityv5.ActivityProductShortListResponse_ErrorResponse{
			ErrorResponse: &activityv5.ActivityProductShortListErrorResponse{
