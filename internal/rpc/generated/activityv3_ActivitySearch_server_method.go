...
func (s *activityv3ActivitySearchServer) ActivitySearch(ctx context.Context, request *activityv3.ActivitySearchRequest) (*activityv3.ActivitySearchResponse, error) {
...
func (s *activityv3ActivitySearchServer) errorResponse(errorMessage string) *activityv3.ActivitySearchResponse {
