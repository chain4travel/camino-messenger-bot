...
var _ transportv4grpc.TransportProductListServiceServer = (*transportv4TransportProductListServiceServer)(nil)

type transportv4TransportProductListServiceServer struct {
...
func registerTransportProductListServiceV4Server(grpcServer *grpc.Server, reqHandler rpc.RequestHandler) {
	transportv4grpc.RegisterTransportProductListServiceServer(grpcServer, &transportv4TransportProductListServiceServer{reqHandler})
}
