...
func (s ValidationServiceV3Client) Call(ctx context.Context, requestIntf protoreflect.ProtoMessage, opts ...grpc.CallOption) (protoreflect.ProtoMessage, types.MessageType, error) {
...
func (s *ValidationServiceV3Client) ErrorResponseAndType(errorMessage string) (protoreflect.ProtoMessage, types.MessageType) {
	return s.errorResponse(errorMessage), ValidationServiceV3Response
}

func (s *ValidationServiceV3Client) errorResponse(errorMessage string) protoreflect.ProtoMessage {
