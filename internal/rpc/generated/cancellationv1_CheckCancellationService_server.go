...
var _ cancellationv1grpc.CheckCancellationServiceServer = (*cancellationv1CheckCancellationServiceServer)(nil)

type cancellationv1CheckCancellationServiceServer struct {
...
func registerCheckCancellationServiceV1Server(grpcServer *grpc.Server, reqHandler rpc.RequestHandler) {
	cancellationv1grpc.RegisterCheckCancellationServiceServer(grpcServer, &cancellationv1CheckCancellationServiceServer{reqHandler})
}
