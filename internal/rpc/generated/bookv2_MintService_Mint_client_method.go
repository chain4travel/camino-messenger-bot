...
func (s *MintServiceV2Client) ErrorResponseAndType(errorMessage string) (protoreflect.ProtoMessage, types.MessageType) {
	return s.errorResponse(errorMessage), MintServiceV2Response
}

func (s *MintServiceV2Client) errorResponse(errorMessage string) protoreflect.ProtoMessage {
