...
func (s TransportSearchServiceV2Client) Call(ctx context.Context, requestIntf protoreflect.ProtoMessage, opts ...grpc.CallOption) (protoreflect.ProtoMessage, types.MessageType, error) {
	...
	if !ok {
		return s.errorResponse(fmt.Sprintf("invalid request type: expected %s, got %T", TransportSearchServiceV2Request, requestIntf)), messageType, nil
	}
...
func (s *TransportSearchServiceV2Client) ErrorResponseAndType(errorMessage string) (protoreflect.ProtoMessage, types.MessageType) {
	return s.errorResponse(errorMessage), TransportSearchServiceV2Response
}

func (s *TransportSearchServiceV2Client) errorResponse(errorMessage string) protoreflect.ProtoMessage {
