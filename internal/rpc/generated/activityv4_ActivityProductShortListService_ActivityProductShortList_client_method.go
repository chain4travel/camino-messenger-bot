...
func (s ActivityProductShortListServiceV4Client) Call(ctx context.Context, requestIntf protoreflect.ProtoMessage, opts ...grpc.CallOption) (protoreflect.ProtoMessage, types.MessageType, error) {
	...
	if !ok {
		return s.errorResponse(fmt.Sprintf("invalid request type: expected %s, got %T", ActivityProductShortListServiceV4Request, requestIntf)), messageType, nil
	}
...
func (s *ActivityProductShortListServiceV4Client) ErrorResponseAndType(errorMessage string) (protoreflect.ProtoMessage, types.MessageType) {
	return s.errorResponse(errorMessage), ActivityProductShortListServiceV4Response
}

func (s *ActivityProductShortListServiceV4Client) errorResponse(errorMessage string) protoreflect.ProtoMessage {
