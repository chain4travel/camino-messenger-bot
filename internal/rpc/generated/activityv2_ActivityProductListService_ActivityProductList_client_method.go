...
func (s ActivityProductListServiceV2Client) Call(ctx context.Context, requestIntf protoreflect.ProtoMessage, opts ...grpc.CallOption) (protoreflect.ProtoMessage, types.MessageType, error) {
	...
	if !ok {
		return s.errorResponse(fmt.Sprintf("invalid request type: expected %s, got %T", ActivityProductListServiceV2Request, requestIntf)), messageType, nil
	}
...
func (s *ActivityProductListServiceV2Client) ErrorResponseAndType(errorMessage string) (protoreflect.ProtoMessage, types.MessageType) {
	return s.errorResponse(errorMessage), ActivityProductListServiceV2Response
}

func (s *ActivityProductListServiceV2Client) errorResponse(errorMessage string) protoreflect.ProtoMessage {
