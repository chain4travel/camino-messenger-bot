...
func (s AccommodationProductInfoServiceV4Client) Call(ctx context.Context, requestIntf protoreflect.ProtoMessage, opts ...grpc.CallOption) (protoreflect.ProtoMessage, types.MessageType, error) {
	...
	if !ok {
		return s.errorResponse(fmt.Sprintf("invalid request type: expected %s, got %T", AccommodationProductInfoServiceV4Request, requestIntf)), messageType, nil
	}
...
func (s *AccommodationProductInfoServiceV4Client) ErrorResponseAndType(errorMessage string) (protoreflect.ProtoMessage, types.MessageType) {
	return s.errorResponse(errorMessage), AccommodationProductInfoServiceV4Response
}

func (s *AccommodationProductInfoServiceV4Client) errorResponse(errorMessage string) protoreflect.ProtoMessage {
