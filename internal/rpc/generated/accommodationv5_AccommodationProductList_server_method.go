...
func (s *accommodationv5AccommodationProductListServer) AccommodationProductList(ctx context.Context, request *accommodationv5.AccommodationProductListRequest) (*accommodationv5.AccommodationProductListResponse, error) {
	...
	responseIntf, err := s.reqHandler.HandleMessageRequest(ctx, AccommodationProductListServiceV5Request, request)
	switch {
	...
	response, ok := responseIntf.(*accommodationv5.AccommodationProductListResponse)
	if !ok {
		return s.errorResponse(typesv4.ErrorCode_ERROR_CODE_INTERNAL, fmt.Sprintf("invalid response type: expected %s, got %T", AccommodationProductListServiceV5Response, responseIntf)), nil
	}

	return response, nil
}

func (s *accommodationv5AccommodationProductListServer) errorResponse(code typesv4.ErrorCode, errorMessage string) *accommodationv5.AccommodationProductListResponse {
