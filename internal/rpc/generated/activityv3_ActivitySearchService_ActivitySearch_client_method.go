...
func (s ActivitySearchServiceV3Client) Call(ctx context.Context, requestIntf protoreflect.ProtoMessage, opts ...grpc.CallOption) (protoreflect.ProtoMessage, types.MessageType, error) {
	...
	if !ok {
		return s.errorResponse(fmt.Sprintf("invalid request type: expected %s, got %T", ActivitySearchServiceV3Request, requestIntf)), messageType, nil
	}
...
func (s *ActivitySearchServiceV3Client) ErrorResponseAndType(errorMessage string) (protoreflect.ProtoMessage, types.MessageType) {
	return s.errorResponse(errorMessage), ActivitySearchServiceV3Response
}

func (s *ActivitySearchServiceV3Client) errorResponse(errorMessage string) protoreflect.ProtoMessage {
