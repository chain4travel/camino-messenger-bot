...
func (s ActivitySearchServiceV2Client) Call(ctx context.Context, requestIntf protoreflect.ProtoMessage, opts ...grpc.CallOption) (protoreflect.ProtoMessage, types.MessageType, error) {
	...
	if !ok {
		return s.errorResponse(fmt.Sprintf("invalid request type: expected %s, got %T", ActivitySearchServiceV2Request, requestIntf)), messageType, nil
	}
...
func (s *ActivitySearchServiceV2Client) ErrorResponseAndType(errorMessage string) (protoreflect.ProtoMessage, types.MessageType) {
	return s.errorResponse(errorMessage), ActivitySearchServiceV2Response
}

func (s *ActivitySearchServiceV2Client) errorResponse(errorMessage string) protoreflect.ProtoMessage {
