...
func (s *accommodationv3AccommodationProductListServer) AccommodationProductList(ctx context.Context, request *accommodationv3.AccommodationProductListRequest) (*accommodationv3.AccommodationProductListResponse, error) {
	...
	responseIntf, err := s.reqHandler.HandleMessageRequest(ctx, AccommodationProductListV3Request, request)
	if err != nil {
	...
	if !ok {
		return s.errorResponse(fmt.Sprintf("invalid response type: expected %s, got %T", AccommodationProductListV3Response, response)), nil
	}
