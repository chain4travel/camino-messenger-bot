...
func (s AccommodationProductListServiceV3Client) Call(ctx context.Context, requestIntf protoreflect.ProtoMessage, opts ...grpc.CallOption) (protoreflect.ProtoMessage, types.MessageType, error) {
	...
	if !ok {
		return s.errorResponse(fmt.Sprintf("invalid request type: expected %s, got %T", AccommodationProductListServiceV3Request, requestIntf)), messageType, nil
	}
...
func (s *AccommodationProductListServiceV3Client) ErrorResponseAndType(errorMessage string) (protoreflect.ProtoMessage, types.MessageType) {
	return s.errorResponse(errorMessage), AccommodationProductListServiceV3Response
}

func (s *AccommodationProductListServiceV3Client) errorResponse(errorMessage string) protoreflect.ProtoMessage {
