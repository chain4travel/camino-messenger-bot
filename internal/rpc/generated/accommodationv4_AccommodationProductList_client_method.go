...
func (s *AccommodationProductListV4Client) Call(ctx context.Context, requestIntf protoreflect.ProtoMessage, opts ...grpc.CallOption) (protoreflect.ProtoMessage, types.MessageType) {
	...
	if !ok {
		return s.errorResponse(typesv4.ErrorCode_ERROR_CODE_INTERNAL, fmt.Sprintf("invalid request type: expected %s, got %T", AccommodationProductListServiceV4Request, requestIntf)), messageType
	}
...
func (s *AccommodationProductListV4Client) InvalidProtoErrResponseAndType(errorMessage string) (protoreflect.ProtoMessage, types.MessageType) {
	return s.errorResponse(typesv4.ErrorCode_ERROR_CODE_INVALID_PROTO, errorMessage), AccommodationProductListServiceV4Response
}

func (s *AccommodationProductListV4Client) errorResponse(code typesv4.ErrorCode, errorMessage string) *accommodationv4.AccommodationProductListResponse {
