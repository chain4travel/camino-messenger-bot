...
// Source: buf.build/gen/go/chain4travel/camino-messenger-protocol/grpc/go/cmp/services/activity/v1/activityv1grpc (interfaces: ActivityProductListServiceClient)
//
// Generated by this command:
//
//	mockgen -package=messaging -destination=internal/messaging/mock_list_grpc.pb.go buf.build/gen/go/chain4travel/camino-messenger-protocol/grpc/go/cmp/services/activity/v1/activityv1grpc ActivityProductListServiceClient
//
...
func (m *MockActivityProductListServiceClient) ActivityProductList(arg0 context.Context, arg1 *activityv1.ActivityProductListRequest, arg2 ...grpc.CallOption) (*activityv1.ActivityProductListResponse, error) {
	m.ctrl.T.Helper()
	...
	ret0, _ := ret[0].(*activityv1.ActivityProductListResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
