...
var (
	_ compression.Compressor[*Message, [][]byte] = (*chunkingCompressor)(nil)
	_ compression.Compressor[*Message, [][]byte] = (*noopCompressor)(nil)
...
func NewCompressor(maxChunkSize int) compression.Compressor[*Message, [][]byte] {
...
func (c *chunkingCompressor) Compress(msg *Message) ([][]byte, error) {
...
func (*noopCompressor) Compress(_ *Message) ([][]byte, error) {
	return [][]byte{{}}, nil
}
