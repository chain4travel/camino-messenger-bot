...
func NewActivityProductInfoV1Server(eventSender events.Sender) activityv1grpc.ActivityProductInfoServiceServer {
	return &activityProductInfoV1Server{eventSender: eventSender}
}
