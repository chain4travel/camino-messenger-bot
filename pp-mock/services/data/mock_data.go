...
var (
	...
	ServiceFactDefinitionsV4Mapping map[string]*typesv4.ServiceFactDefinition // TODO@
...
func init() {
	...
	ServiceFactDefinitionsV4Mapping = accommodation.VerifyAndGetMapping(ServiceFactsV4, ServiceFactDefinitionsV4)
	// TransportV2
