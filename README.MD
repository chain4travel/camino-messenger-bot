...
The application supports tracing by providing an otel (OpenTelemetry) [sdk](https://opentelemetry.io/docs/languages/go/)
...
For the moment the application uses a Jaeger exporter to send the traces to a [Jaeger](https://www.jaegertracing.io/)
