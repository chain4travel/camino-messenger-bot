...
If you don't already have a **CM Account** your company should [register and get listed as a Partner](https://docs.camino.network/partners/partner-showroom/index.html#being-listed-as-a-partner). Following this process will result in CM account and all necessary pre-requirements to run the  bot on main net Camino. It is necessary to create the CM Account this way for the main net Camino. 

For development purposes, it is also possible to be listed as Partner on test net Columbus. <HOW EXACTLY>

> [!IMPORTANT]
> We discourage using the same wallets on test net Columbus and main net Camino

For development purposes, a CM Account can also be created and configured without being listed as a Partner - via [camino messenger contracts](https://github.com/chain4travel/camino-messenger-contracts) `hardhat` tool or via [suite](https://suite.camino.network) as explained [here](https://docs.camino.network/partners/partner-config/#step-by-step-configuration-guide).
